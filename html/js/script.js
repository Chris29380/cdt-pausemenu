	...
	<div class="btonplayerinfo" id="btonplayerinfo">					
		<div class="btoncontent" id="btoncontent">
			...
			<div class="job1p" id="job1p">			
				...
				<div class="value" id="value">
					<div class="valuejob" id="valuejob">Ambulance - Doctor</div>
					<div class="valuesalary" id="valuesalary">1100 $</div>
				</div>
			</div>
			<div class="job2p" id="job2p">			
				...
				<div class="value" id="value">
					<div class="valuejob" id="valuejob">Police - Officer</div>
					<div class="valuesalary" id="valuesalary">1250 $</div>
				</div>
			</div>
